    ...
    <div className="auth-page">
      <div style={{ 
        ...
        <div style={{ display: 'flex', width: '100%', background: 'rgba(15,23,42,0.05)', borderRadius: '12px', padding: '0.25rem', marginBottom: '2rem' }}>
          ...
          <Link to="/register" style={{ flex: 1, color: 'var(--text-muted)', textAlign: 'center', padding: '0.6rem', borderRadius: '8px', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none' }}>
             Register
          </Link>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
            <a href="#" style={{ fontSize: '0.8rem', color: 'var(--text-muted)', textDecoration: 'none' }}>Forgot password?</a>
          </div>
