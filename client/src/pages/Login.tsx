      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ marginTop: 'auto', marginBottom: 'auto' }}>
            <h1 style={{ fontSize: '2.5rem', fontWeight: 700, marginBottom: '1rem', lineHeight: 1.2 }}>Welcome Back! 👋</h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '1.1rem', marginBottom: '3rem' }}>Sign in to your account to continue</p>
        ...
        <div style={{ flex: 1, padding: '3rem 4rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
          <h2 style={{ fontSize: '1.8rem', fontWeight: 600, marginBottom: '2rem' }}>Sign In</h2>
          
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              <label style={{ fontSize: '0.9rem', fontWeight: 500, color: 'var(--text-muted)' }}>Email</label>
              <input 
                type="email" 
                ...
                required 
                style={{ width: '100%', padding: '0.85rem 1rem', background: 'rgba(15,23,42,0.6)', border: '1px solid var(--surface-border)', borderRadius: '8px', color: 'white', outline: 'none' }}
              />
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              <input 
                ...
                required 
                style={{ width: '100%', padding: '0.85rem 1rem', background: 'rgba(15,23,42,0.6)', border: '1px solid var(--surface-border)', borderRadius: '8px', color: 'white', outline: 'none', letterSpacing: '2px' }}
              />
            </div>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            <button style={{ flex: 1, padding: '0.75rem', background: 'rgba(255,255,255,0.05)', border: '1px solid var(--surface-border)', borderRadius: '8px', color: 'white', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
